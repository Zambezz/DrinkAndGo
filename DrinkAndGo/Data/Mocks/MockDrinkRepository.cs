...

			{
...

				{
					...
					new Drink {
						...
						ImageUrl = "../Images/beer1.png",

						InStock = true,

						IsPreferredDrink = true,

						ImageThumbnailUrl = "../Images/beer2.png"
					...
					new Drink {
						...
						ImageThumbnailUrl = "../Images/rum2.jpg"
					...
					new Drink {
						...
						ImageUrl = "../Images/tequila1.jpg",

						InStock = true,

						IsPreferredDrink = false,

						ImageThumbnailUrl = "../Images/tequila2.jpg"
...

					{
						...
						ImageThumbnailUrl = "../Images/juice2.jpg"
